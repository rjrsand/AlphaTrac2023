...
<div class="d-flex flex-column justify-content-between h-100">
    ...
    <div class="d-flex justify-content-center pb-3">
        <a class="nav-item nav-link text-light text-nowrap" href="privacy-policy.php" style="color: white !important;">Privacy Policy</a>
        <a class="nav-item nav-link text-light" style="color: white !important;">|</a>
        <a class="nav-item nav-link text-light text-nowrap" href="terms-of-service.php" style="color: white !important;">Terms of Service</a>
    </div>
</div>